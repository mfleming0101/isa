...
pub const arm_requirements = host_requirements ++ [_]Requirement{
    ...
    .{ .name = "floatingPoint", .Signature = fn (*anyopaque) bool, .why = "whether a floating-point or vector unit is implemented at all, which is what makes CONTROL.FPCA, and SFPA on a Secure core, writable bits rather than reserved ones, C2.4.126" },
